...
baffoussam = City.new("Baffoussam")
limbe = City.new("Limbe")
douala = City.new("Douala")
yaounde = City.new("Yaounde")
bamenda = City.new("Bamenda")
baffoussam.add_route(limbe, 100)
baffoussam.add_route(yaounde, 160)
limbe.add_route(douala, 120)
limbe.add_route(yaounde, 180)
douala.add_route(bamenda, 80)
yaounde.add_route(douala, 40)
yaounde.add_route(bamenda, 140)
...
p dijkstra_shortest_path(baffoussam, bamenda)